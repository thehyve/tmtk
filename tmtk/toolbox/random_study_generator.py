...
the_wrestling_glossary = [
    ...
    "Double team", "Double turn", "Draw", "Drop", "Dusty finish", "Enforcer", "Extreme wrestling", "Face",
    ...
    "Paper champion", "Parts Unknown", "Payoff", "Pinfall", "Pipe bomb", "Plant", "Policeman", "Pop", "Potato",
    "Powdering", "Program", "Promo", "Pull apart", "Put Over", "Puroresu", "Push",
